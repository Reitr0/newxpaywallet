...
export const DEFAULTS_NETWORKS = {
  ...
  slx: {
    mainnet: {
      chainId: 781234,
      label: 'SLX Network',
      rpc: 'https://slxscan.io/rpc',
      explorerTxBase: 'https://slxscan.io/tx/',
      explorerAddressBase: 'https://slxscan.io/address/',
      logoUrl: 'https://i.ibb.co/GC5VBgq/SLX-COIN-241209.png',
      symbol: 'SLX',
      decimals: 18,
    },
  },
